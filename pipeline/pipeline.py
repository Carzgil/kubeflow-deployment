...
@pipeline(name="CIFAR-10 Pipeline", description="Pipeline for preprocessing, training, and evaluating CIFAR-10 model.")
...
if __name__ == "__main__":
    kfp.compiler.Compiler().compile(cifar10_pipeline, "cifar10_pipeline.yaml")
